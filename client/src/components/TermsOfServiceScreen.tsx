          ...
          <>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3 text-gray-300 text-sm leading-relaxed">
                ...
                <p>
                  By using our application, you agree to the collection and use of information in accordance with our Privacy Policy.
                </p>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3 text-gray-300 text-sm leading-relaxed">
                <p>
                  We reserve the right to update these terms and conditions at any time without prior notice. Your continued use of the application following any changes indicates your acceptance of the new terms.
                </p>
