...
// App with instant launch + loading screen for server connection
function App() {
  ...
  useEffect(() => {
    ...
    const initializeApp = async () => {
      ...
      // Test server connection after app launch (with faster timeout)
      try {
        ...
        console.log('Server connection will retry:', error);
        // Continue without server connection for offline functionality
        setIsServerReady(true);
      }
